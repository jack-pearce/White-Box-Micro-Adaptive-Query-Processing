...
This repository provides the implementation of White-Box Micro-Adaptive Query Processing, as described in our paper submitted to VLDB 2025. The project addresses micro-architectural hazards in in-memory data management systems, such as cache misses and branch mispredictions, through hazard-adaptive query execution.
